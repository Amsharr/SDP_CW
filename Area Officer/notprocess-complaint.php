                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php $query=mysqli_query($con,"select complaints.*,complainers.firstName as name from complaints join complainers on complainers.userId=complaints.userId where complaints.status is null ");
$cnt=1;
...
<td>   <a href="complaint-details.php?cid=<?php echo htmlentities($row['complaintId']);?>" class="btn btn-primary"> View Details</a> 
											</td>
