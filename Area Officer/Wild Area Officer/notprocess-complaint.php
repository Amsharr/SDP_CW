                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php
$query = mysqli_query($con, "select complaints.*,complainers.firstName as name from complaints join complainers on complainers.userId=complaints.userId where complaints.status is null ");
$cnt = 1;
