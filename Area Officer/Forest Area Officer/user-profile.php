...
//         $sql = mysqli_query($con, "update areaofficers set firstName='$firstName',lastName='$lastName', contactNo='$contactNo', username='$username' password='$password'  where officerId='$officerId'");
...
$query=mysqli_query($con,"select * from areaofficers where officerId='$officerId '");
