...
$sql =mysqli_query($con,"SELECT userId FROM complainers WHERE email='$email' and contactNo='$contactNo'");
$rowcount=mysqli_num_rows($sql);

if($rowcount >0)
{
$query=mysqli_query($con,"update complainers set password='$newpassword' where email='$email' and contactNo='$contactNo'");
if($query){
