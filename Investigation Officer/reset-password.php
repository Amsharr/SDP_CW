...
$sql =mysqli_query($con,"SELECT officerId FROM investigationofficers WHERE username='$username' and contactNo='$contactNo'");
$rowcount=mysqli_num_rows($sql);

if($rowcount >0)
{
$query=mysqli_query($con,"update investigationofficers set password='$newpassword' where username='$username' and contactNo='$contactNo'");
if($query){
...
<head>
	<title>CMS | Investigator Officer Password Recovery</title>
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<h4>Complaint management system <hr /><span style="color:#fff;"> Investigator Password Recovery</span></h4>
